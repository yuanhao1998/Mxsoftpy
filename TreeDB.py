        ...
        if sub_key:
            try:
                ...
                try:
                    ...
                    self.exec('bs_treedb_open', main_key, sub_key, main_key_pwd, TRDB_OPKF_OPENEXIST, file, host, port)
            ...
            try:
                ...
                try:
                    ...
                    try:
                        ...
                        self.__chl = CBSHandleLoc()
                        # self.exec_tree('Treedb_Alloc', host, file, main_key, main_key_pwd, TRDB_OPKF_OPENEXIST, port)
                        self.exec('bs_treedb_open', main_key, '', main_key_pwd, TRDB_OPKF_OPENEXIST, file, host, port)
